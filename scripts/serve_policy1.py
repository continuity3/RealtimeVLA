...
class Args:
    ...
    # Specifies how to load the policy. Default is to use official torch checkpoint for LIBERO.
    # Can be: Default, Checkpoint, or LocalCheckpoint
    policy: Checkpoint | Default | LocalCheckpoint = dataclasses.field(
        default_factory=lambda: LocalCheckpoint(
            path="/home/wyz/openpi/checkpoints/pi05_pick_blue_bottle_libero_downsample4x/downsample4x_right_arm_finetune/15000",
            config="pi05_libero",
        )
    )
